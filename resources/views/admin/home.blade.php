    ...
    <div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="{{ url('/admin/setting/basesetting/clearcache') }}" class="ajaxBtn">刷新缓存</a></li>
                            <li><a href="{{ url('/admin/setting/adminusers/password') }}" target="rIframe">修改密码</a></li>
                            <li><a href="{{ url('/admin/logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">安全退出</a></li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="rIframe" id="rIframe" width="100%" height="100%" frameborder="0" src="/admin/map"></iframe>
            </div>
        </div>
        <!--右侧部分结束-->
    </div>
