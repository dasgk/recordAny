            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="{{url('/admin/user/users')}}">用户列表</a></li>
                        <li><a href="{{url('/admin/user/users/add')}}">添加用户</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <form role="form" class="form-inline" method="get">
                            ...
                            <button type="button" class="btn btn-white" onclick="location.href='{{url('/admin/user/users')}}'">重置</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable">
                            ...
                            @foreach($users as $user)
                                <tr class="gradeA">
                                    ...
                                    <td>
                                        <a href="{{url('/admin/user/users/edit/' . $user['uid'])}}">编辑</a>
                                        | <a class="ajaxBtn" href="javascript:void(0);" uri="{{url('/admin/user/users/delete/' . $user['uid'])}}" msg="是否删除该用户？">删除</a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
