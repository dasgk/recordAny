            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        ...
                        <li @if(!isset($user))class="active"@endif><a href="{{url('/admin/user/users/add')}}">添加用户</a></li>
                        @if(isset($user))
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form action="{{url('/admin/user/users/save')}}" method="post" class="form-horizontal ajaxForm">
