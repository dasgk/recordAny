            ...
            <div class="col-sm-12">
                <div class="tabs-container">
                    <ul class="nav nav-tabs">
                        <li><a href="{{url('/admin/setting/adminusers')}}">管理员列表</a></li>
                        <li @if(!isset($user))class="active"@endif><a href="{{url('/admin/setting/adminusers/add')}}">添加管理员</a></li>
                        @if(isset($user))
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form action="{{url('/admin/setting/adminusers/save')}}" method="post" class="form-horizontal ajaxForm">
