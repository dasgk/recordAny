...
<div class="flex-center position-ref full-height">
    ...
    <div class="content">
        ...
        <div class="links">
            <?php if(Auth::check()): ?>
                <a href="<?php echo e(url("/show_new_record?p=c")); ?>">New Record</a>
            <?php else: ?>
                <a href="javascript:void(0)" onclick="showLoginPage()">Login</a>
            <?php endif; ?>
            <a href="<?php echo e(url("/content?p=c")); ?>">Just Look</a>
        </div>
    </div>
</div>
<!-- 用户登录 Modal 开始****************-->
...
<div class="modal fade" id="registerModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document" style="width:400px">
        <div class="modal-content">
            ...
            <div class="form-inline" style="text-align:center" action="<?php echo e(url('user/register')); ?>" method="post">
                <input type="hidden" name="p" value="c">
...
<script src="<?php echo e(asset('plugins/bootstrap-3.3.7-dist/js/bootstrap.min.js')); ?>"></script>
<script >
    ...
    function do_login() {
        $.ajax({
            type: "post",
            url: "<?php echo e(url('/user/login?p=c')); ?>",
            async: false,
            data: {"user_name": $("#user_name").val(),"password":$("#password").val(),   "_token":"<?php echo e(csrf_token()); ?>"},
    ...
    function do_register() {
        $.ajax({
            type: "post",
            url: "<?php echo e(url('/user/register?p=c')); ?>",
            async: false,
